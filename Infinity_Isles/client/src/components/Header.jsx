        ...
        <div className="bg-gray-200">
            <div className="flex justify-between items-center py-1.5 mx-7">
                ...
                <div className="sm:flex items-center cursor-pointer">
                    <div className="flex flex-col items-end -mr-5 sm:mx-1 md:mx-2 lg:mx-3 xl:mx-4"><span className="text-[9px] font-medium md:text-[11px] lg:text-xs xl:text-sm">Hello Guest</span><span className="text-xs font-bold leading-5 md:text-sm lg:text-base xl:text-lg">Signup</span></div>
