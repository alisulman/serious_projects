    ...
    return (
        <RegistrationWrap>
            <div className="container flex flex-col justify-center items-center mx-auto">
                ...
                <h1 className="flex text-sm my-3 sm:text-base md:text-lg lg:text-xl xl:text-2xl">Already have an account?<Link to='/registeration/login' className='flex items-center text-xs text-blue-600 sm:text-sm md:text-base lg:text-lg xl:text-xl'>Login</Link></h1>
            </div>
