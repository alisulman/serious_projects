                    ...
                    <div className="flex flex-wrap text-left lg:text-left">
                        <div className="w-full lg:w-6/12 px-4">
                            ...
                            <div className="flex mt-6 lg:mb-0 mb-6">
                                <button className="flex bg-white shadow-lg font-normal h-10 w-10 items-center justify-center align-center rounded-full outline-none focus:outline-none mr-2" type="button">
                                    <FaTwitter className="text-blue-500 text-2xl" />
                                </button>
                                <button className="flex bg-white shadow-lg font-normal h-10 w-10 items-center justify-center align-center rounded-full outline-none focus:outline-none mr-2" type="button">
                                    <FaFacebookF className="text-indigo-800 text-2xl" />
                                </button>
                                <button className="flex bg-white shadow-lg font-normal h-10 w-10 items-center justify-center align-center rounded-full outline-none focus:outline-none mr-2" type="button">
                                    <CiBasketball className="text-orange-700 text-2xl" />
                                </button>
                                <button className="flex bg-white shadow-lg font-normal h-10 w-10 items-center justify-center align-center rounded-full outline-none focus:outline-none mr-2" type="button">
                    ...
                    <div className="flex flex-wrap items-center md:justify-between justify-center">
                        <div className="w-full md:w-4/12 px-4 mx-auto text-center">
                            <div className="text-sm text-blueGray-500 font-semibold py-1">
                                Copyright © <span>2024</span><a href="/" className="text-blueGray-500 hover:text-gray-800" target="_blank" /> Infinity Isles by Ali Sulman
                            </div>
                        </div>
                    </div>
                </div>
