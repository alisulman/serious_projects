...
const DashboardV = () => {
  return (
    <>
      <div>
        <Link to='/' className="inline-flex flex-col justify-center items-center text-sm font-semibold uppercase sm:text-base md:text-lg lg:text-2xl xl:text-3xl my-3 mx-[550px]"><Logo color='black' /><div className='mx-4 -my-2'>Infinity Isles</div></Link>
      </div>
